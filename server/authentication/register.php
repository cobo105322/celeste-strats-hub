...
if(!isset($_POST["user"]) || !isset($_POST["password"]) || !isset($_POST["email"]) || !filter_var($_POST["email"], FILTER_VALIDATE_EMAIL)){
...
$stmt -> bind_param("sss", $_POST["user"], $password, $_POST["email"]);
$stmt->execute();
